-- Rollback for supabase/migrations/20260925100000_siparis_sahibi_kurali.sql.
-- Puts back the A8 (20260924150000) body of tomnap_v2_siparis_olustur: the owner
-- defaults to the creator, SUPER_ADMIN included. Drops nothing. Does nothing when the
-- A8 function is already gone (rollbacks run newest first), so it can run twice.
